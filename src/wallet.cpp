...
// SpamSlayer: total coins staked (non-spendable until maturity)
...
// SpamSlayer: check 'spent' consistency between wallet and txindex
// SpamSlayer: fix wallet spent state according to txindex
...
// SpamSlayer: disable transaction (only for coinstake)
