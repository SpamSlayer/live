...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        (    0,	uint256("0x000002df26bac377cc54d6d2d948a407d329edc0c65eab0de63fcd1af898e313") ) 
        ...
        (   11800,	uint256("0xedaf8e6ed49b01d49c22ea4e9f4753bc583bcfbe102ea98d8c1b1eb1ecdbf4fe") ) //FORK
    ...
    // SpamSlayer: synchronized checkpoint (centrally broadcasted)
    ...
    // SpamSlayer: get last synchronized checkpoint
    ...
    // SpamSlayer: only descendant of current sync-checkpoint is allowed
    ...
    // SpamSlayer: reset synchronized checkpoint to last hardened checkpoint
...
// SpamSlayer: sync-checkpoint master key
...
// SpamSlayer: verify signature of sync-checkpoint message
...
// SpamSlayer: process synchronized checkpoint
